...
public class ImageZoom {
     ...
     * @param sysimgfilenNow 处理后的图片文件名前缀
     */
    public ImageZoom(String fromFileStr, String saveToFileStr, String sysimgfile, String suffix, int width, int height) {
    ...
    public static void main(String[] args) {
        ...
        boolean ss = false;
        try {
            UI = new ImageZoom("C:\\Users\\Administrator\\Pictures\\111.jpg", "C:\\Users\\Administrator\\Pictures\\", "ps_low2", "png", 280, 280);
